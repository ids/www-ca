...
(function() {
  ...
  TouchSplitter = (function() {
    ...
    TouchSplitter.prototype.toggleDock = function() {
      ...
      if (this.docked) {
        this.callback.undocking();
        return this.setDock(false);
      } else {
        this.callback.docking();
        return this.setDock(this.docks.name);
      }
    };

    TouchSplitter.prototype.dockSplitter = function() {
      this.callback.docking();
      return this.setDock(this.docks.name);
    };

    TouchSplitter.prototype.undockSplitter = function() {
      console.log("splitter dock state: " + this.docked);
